...
def plot_analysis(fname=None):
    if not fname:
        # if no file name provided, show figure with pyplot
        fig = plt.figure()
    else:
        # if a file name is provided, set up canvas to print figure
    ...
    if not fname:
        ...
        # if a file name is provided, pretty print all using tex, and render
        # to file
        mlib.rcParams['text.usetex'] = True
        mlib.rcParams['text.latex.preamble'] = '\usepackage{libertine}'
        fig.tight_layout()
